...
const Footer = () => {
    ...
    return (
        ...
        <div className="footer-payment">
            <h2>We accept..</h2>
            <img className="payment_methods" src="images/payment_methods.png" alt="payment methods"></img>
        </div>
        <div className="footer-apps">
            <h2>Get the app</h2>
            <img className="footer-apple-store" src="images/app_store_logo.png" alt="apple app store"></img>
            <img className="footer-google-store" src="images/google_play_logo.png" alt="google play store"></img>
        </div>
